/* Automatically generated by gen_abi from /home/pvanmildert/paparazzi/conf/abi.xml */
/* Version v6.4.0_stable-none-g71e15e43e */
/* Please DO NOT EDIT */
...
#define ABI_MODELDATA_ID 38

/* Array and linked list structure */
#define ABI_MESSAGE_NB 39
...
typedef void (*abi_callbackMODELDATA)(uint8_t sender_id, float v1, float v2, float v3, float v4, float v5);
...
static inline void AbiBindMsgMODELDATA(uint8_t sender_id, abi_event * ev, abi_callbackMODELDATA cb) {
    if (abi_queues[ABI_MODELDATA_ID] == ev) return;
    ev->id = sender_id;
    ev->cb = (abi_callback)cb;
    ABI_PREPEND(abi_queues[ABI_MODELDATA_ID], ev);
}


static inline void AbiSendMsgMODELDATA(uint8_t sender_id, float v1, float v2, float v3, float v4, float v5) {
    abi_event* e;
    ABI_FOREACH(abi_queues[ABI_MODELDATA_ID], e) {
        if (e->id == ABI_BROADCAST || e->id == sender_id) {
            abi_callbackMODELDATA cb = (abi_callbackMODELDATA)(e->cb);
            cb(sender_id, v1, v2, v3, v4, v5);
        }
    }
}
