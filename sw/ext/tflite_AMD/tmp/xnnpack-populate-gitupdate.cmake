...
execute_process(
  COMMAND "/usr/bin/git" show-ref "6a834a09c53765bea56b8aea9a644a90564fe3a5"
  WORKING_DIRECTORY "/home/daniel/tflite_build/xnnpack"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "6a834a09c53765bea56b8aea9a644a90564fe3a5")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("6a834a09c53765bea56b8aea9a644a90564fe3a5" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/6a834a09c53765bea56b8aea9a644a90564fe3a5")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/daniel/tflite_build/xnnpack'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/daniel/tflite_build/xnnpack'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
