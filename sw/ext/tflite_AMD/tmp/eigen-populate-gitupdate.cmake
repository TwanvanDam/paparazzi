...
execute_process(
  COMMAND "/usr/bin/git" show-ref "4c38131a16803130b66266a912029504f2cf23cd"
  WORKING_DIRECTORY "/home/daniel/tflite_build/eigen"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/daniel/tflite_build/eigen'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/daniel/tflite_build/eigen'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
